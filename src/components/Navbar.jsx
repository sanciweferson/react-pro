...
export default function Navbar() {
  ...
  { name: "About", path: "/about", icon: <Info size={20} /> },       // Corrigido de "Image" para "Info"
  { name: "Details", path: "/details", icon: <Image size={20} /> },  // Corrigido spelling e icon pra Image
  { name: "Download", path: "/download", icon: <Download size={20} /> },
  { name: "Contact", path: "/contact", icon: <Mail size={20} /> },   // Corrigido de "Contato" para "Contact"


    { 
      name: "Facebook", 
      path: "https://www.facebook.com/seu-perfil",
      icon: <Facebook size={20} />, 
      external: true 
    },
    { 
      name: "Instagram", 
      path: "https://www.instagram.com/sanciweferson?igsh=cHFyeHlmazVmdDFv",
  ...
  return (
    <div>
      ...
      <nav
        ref={navRef}
        className={`scrollbar-thin py-6 fixed top-0 left-0 right-0 z-[200] flex items-center justify-between py-3 px-4 transition-all duration-500 backdrop-blur-md ${
          scrolled
      ...
      >
        ...
        {/* Menu */}
        <div
          className={`border-r-[4px] border-[var(--border)]
        ...
        >
          ...
          <button
            onClick={toggleTheme}
            className={`flex items-center justify-center w-10 h-10 rounded-full border border-[var(--border)]
